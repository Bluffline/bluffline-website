            ...
            },
            {
              ...
              items: {
                ...
                fields: [
                  ...
                  { name: "stat1Value", type: "string" },
                  { name: "stat1Label", type: "string" },
                  { name: "stat1SourceUrl", type: "url" },
                  { name: "stat1SourceLabel", type: "string" },
                  { name: "stat2Value", type: "string" },
                  { name: "stat2Label", type: "string" },
                  { name: "stat2SourceUrl", type: "url" },
                  { name: "stat2SourceLabel", type: "string" },
                ],
              },
            },
            ...
            { name: "evidenceBody", type: "text" },
            {
              ...
              items: {
                ...
                fields: [
                  ...
                  { name: "sourceLabel", type: "string" },
                  { name: "stat1Value", type: "string" },
                  { name: "stat1Description", type: "string" },
                  { name: "stat2Value", type: "string" },
                  { name: "stat2Description", type: "string" },
                  { name: "stat3Value", type: "string" },
                  { name: "stat3Description", type: "string" },
                ],
              },
            },
